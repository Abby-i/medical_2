...
<body>
	...
	<div class="panel admin-panel">
		<div class="panel-head" id="add">
			<strong><span class="icon-pencil-square-o"></span>增加医疗机构编码信息</strong>
		</div>
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				...
				<div class="form-group">
					...
					<div class="field">
						<select id="lsgx" name="sqddlx" class="input w50">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50"  onclick="WdatePicker({firstDayOfWeek:7})" name="kysj"
							data-validate="required:必填项" />
						<div class="tips"></div>
					</div>
				</div>
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="zczj" placeholder="*万元"
							 data-validate="required:必填项" />
						<div class="tips"></div>
					</div>
				</div>
