...
<div class="error-container"> 
    <h1> 后台管理系统-信息提示 </h1>   
    <div class="errorcon">     
        <span style="display:none;"><i class="icon-frown-o"></i>操作失败! 工号已存在</span>
  操作失败! 工号已存在
   </div>
    <h4 class="smaller">页面自动 <a id="href" href="${pageContext.request.contextPath }/system/UserServlet?m=list">跳转</a> 等待时间： <b id="wait"><?php echo($waitSecond); ?></b></h4> 
