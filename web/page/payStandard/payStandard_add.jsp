	...
	<div class="panel admin-panel">
		...
		<div class="body-content">
			<form id="form-add" method="post" class="form-x"
				action="<%=path%>/system/PayStandardServlet?m=add">
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="<%=nowyear %>" name="annual"
				...
				<div class="form-group">
					...
					<div class="field">
						<input type="text" class="input w50" value="" name="pay_cost" placeholder="单位：元"
							data-validate="required:此项不能为空" />
						<div class="tips"></div>
					</div>
				</div>
				...
				<div class="form-group">
					...
					<div class="field">
						<input  id="d4321" type="text" class="input w50" value="" name="startTime"
